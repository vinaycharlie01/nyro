...
// TestKeyDBIntegration_GetMulti tests the GetMulti operation.
func TestKeyDBIntegration_GetMulti(t *testing.T) {
...
// TestKeyDBIntegration_SetMulti tests the SetMulti operation.
func TestKeyDBIntegration_SetMulti(t *testing.T) {
	keydb := testcontainers.SetupKeyDBContainer(t)
	cacheAdapter := keydb.GetCacheAdapter()
	ctx := context.Background()
...
// TestKeyDBIntegration_DeleteMulti tests the DeleteMulti operation.
func TestKeyDBIntegration_DeleteMulti(t *testing.T) {
	keydb := testcontainers.SetupKeyDBContainer(t)
	cacheAdapter := keydb.GetCacheAdapter()
	ctx := context.Background()
